...
begin {
    ...
    # IndicatorFilename is name of associated file - can be multiple values & should be relatively distinctive file names to minimize false positives
    # FullIndicatorPath is full path to an associated file - ONE value for use if the full path to a file is needed to make a distinct identification, used instead of IndicatorFilename
    $RASList = @(
        ...
        [pscustomobject]@{ Name = "Chrome Remote Desktop"; DisplayName = "Chrome Remote Desktop Host"; ProcessName = "remoting_host"; IndicatorFilename = "remoting_host.exe" }
        [PSCustomObject]@{ Name = "Chrome Remote Desktop"; DisplayName = "Chrome Remote Desktop"; ProcessName = "remote_host", "remoting_host"; IndicatorFilename = "remote_host.exe", "remoting_host.exe" }
        ...
        [PSCustomObject]@{ Name = "Distant Desktop"; DisplayName = "Distant Desktop"; ProcessName = "ddsystem"; IndicatorFilename = "ddsystem.exe", "distant-desktop.exe" }
        ...
        [PSCustomObject]@{ Name = "GoToMyPC"; DisplayName = "GoToMyPC"; ProcessName = "GoToMyPC"; IndicatorFilename = "AppCore.exe" }
        ...
        [pscustomobject]@{ Name = "LiteManager"; DisplayName = "LiteManager Pro - Server"; ProcessName = "ROMServer", "ROMFUSClient"; IndicatorFilename = "ROMFUSClient.exe", "ROMServer.exe" }
        [PSCustomObject]@{ Name = "LiteManager"; DisplayName = "LiteManager"; ProcessName = "xxxxx"; IndicatorFilename = "lmnoipserver.exe", "ROMFUSClient.exe", "romfusclient.exe", "romviewer.exe", "romserver.exe", "ROMServer.exe" }
        ...
        [PSCustomObject]@{ Name = "LogMeIn"; DisplayName = "LogMeIn"; ProcessName = "lmiguardiansvc"; IndicatorFilename = "lmiguardiansvc.exe" }
        [pscustomobject]@{ Name = "LogMeIn"; DisplayName = "LogMeIn"; ProcessName = "LogMeIn"; IndicatorFilename = "LogMeIn.exe", "LogMeInSystray.exe", "support-logmeinrescue.exe" }
        ...
        [pscustomobject]@{ Name = "ManageEngine"; DisplayName = "ManageEngine Remote Access Plus - Server", "ManageEngine UEMS - Agent"; ProcessName = "dcagenttrayicon", "UEMS", "dcagentservice"; IndicatorFilename = "dcagenttrayicon.exe", "UEMS.exe", "dcagentservice.exe" }
        ...
        [pscustomobject]@{ Name = "NoMachine"; DisplayName = "NoMachine"; ProcessName = "nxd", "nxnode.bin", "nxserver.bin", "nxservice64"; IndicatorFilename = "nxd.exe", "nxnode.bin", "nxserver.bin", "nxservice64.exe" }
        ...
        [PSCustomObject]@{ Name = "TigerVNC/TightVNC"; DisplayName = "TigerVNC"; ProcessName = "tvnserver"; IndicatorFilename = "winvnc4.exe", "tvnviewer.exe", "TightVNCViewerPortable*.exe", "tvnserver.exe" }
        [pscustomobject]@{ Name = "TightVNC"; DisplayName = "TightVNC"; ProcessName = "tvnserver"; IndicatorFilename = "tvnserver.exe", "tvnviewer.exe" }
        ...
        [pscustomobject]@{ Name = "(Uncategorized suspect executables)"; IndicatorFilename = "aadg.exe", "agent32.exe", "agent64.exe", "pcstarter.exe", "pocketcloudservice.exe", "pocketcontroller.exe", "psexec.exe", "psexecsvc.exe", "pstlaunch.exe", "ptdskclient.exe", "ptdskhost.exe", "qq.exe", "qqpcmgr.exe", "QQProtect.exe", "raautoup.exe", "RAccess.exe", "Radmin.exe", "rapid7_agent_core.exe", "rapid7_endpoint_broker.exe", "rcengmgru.exe", "rcmgrsvc.exe", "rcstartsupport.exe", "rd.exe", "RDConsole.exe", "RDesktop.exe", "rdp.exe", "RDPCheck.exe", "RDPConf.exe", "RDPWInst.exe", "remcom.exe", "remcomsvc.exe", "remobo.exe", "remobo_client.exe", "remobo_tracker.exe", "remote access.exe", "Remote Desktop.exe", "remote-it-installer.exe", "remote.it.exe", "remote_host.exe", "remoteit.exe", "remotepass-access.exe", "RemotePC.exe", "remotepchost.exe", "RemotePCService.exe", "remotesupportplayeru.exe", "remoteview.exe", "remoting_host.exe", "rfusclient.exe", "RmmService.exe", "rmserverconsolemediator.exe", "ROMFUSClient.exe", "ROMServer.exe", "romviewer.exe", "saazapsc.exe", "serverproxyservice.exe", "TiClientCore.exe", "TiExpertCore.exe", "TiExpertStandalone.exe", "TSClient.exe", "webexpcnow.exe", "winaw32.exe", "WinVNCStub.exe", "xcmd.exe", "xcmdsvc.exe" }
        # Currently no way to wildcard-search executables has been implemented
        #[PSCustomObject]@{ Name = "Adobe Connect"; DisplayName = "Adobe Connect"; ProcessName = "xxxxx"; IndicatorFilename = "ConnectAppSetup*.exe", "ConnectShellSetup*.exe", "ConnectDetector.exe" }
        #[PSCustomObject]@{ Name = "BeInSync"; DisplayName = "BeInSync"; ProcessName = "BeInSync"; IndicatorFilename = "Beinsync*.exe" }
        #[PSCustomObject]@{ Name = "Chrome SSH Extension"; DisplayName = "Chrome SSH Extension"; ProcessName = "xxxxx"; IndicatorFilename = "C:\Users\*\AppData\Local\Google\Chrome\User Data\Default\Extensions\iodihamcpbpeioajjeobimgagajmlibd*, *Users\*\AppData\Local\Google\Chrome\User Data\Default\Extensions\iodihamcpbpeioajjeobimgagajmlibd*" }
        #[PSCustomObject]@{ Name = "DeskDay"; DisplayName = "xxxxx"; ProcessName = "xxxxx"; IndicatorFilename = "ultimate_*.exe" }
        ...
        #[PSCustomObject]@{ Name = "Jump Cloud"; DisplayName = "xxxxx"; ProcessName = "xxxxx"; IndicatorFilename = "JumpCloud*.exe " }
        #[PSCustomObject]@{ Name = "KickIdler"; DisplayName = "KickIdler"; ProcessName = "xxxxx"; IndicatorFilename = "grabberEM.*msi", "grabberTT*.msi" }
        #[PSCustomObject]@{ Name = "MobaXterm"; DisplayName = "xxxxx"; ProcessName = "xxxxx"; IndicatorFilename = "C:\*\MobaXterm_installer_12.1.msi", "*\MobaXterm_installer_*.msi", "*\Mobatek\MobaXterm\*" }
        #[PSCustomObject]@{ Name = "Naverisk"; DisplayName = "xxxxx"; ProcessName = "xxxxx"; IndicatorFilename = "AgentSetup-*.exe" }
        #[PSCustomObject]@{ Name = "NoMachine"; DisplayName = "NoMachine"; ProcessName = "xxxxx"; IndicatorFilename = "nomachine*.exe", "nxservice*.ese", "nxd.exe" }
        #[PSCustomObject]@{ Name = "Onionshare"; DisplayName = "Onionshare"; ProcessName = "xxxxx"; IndicatorFilename = "C:\Program Files (x86)\OnionShare\*", "*\OnionShare\*", "*\onionshare*.exe", "OnionShare-win*.msi" }
        #[PSCustomObject]@{ Name = "Panorama9"; DisplayName = "Panorama9"; ProcessName = "xxxxx"; IndicatorFilename = "p9agent*.exe" }
        #[PSCustomObject]@{ Name = "PDQ Connect"; DisplayName = "PDQ Connect"; ProcessName = "xxxxx"; IndicatorFilename = "pdq-connect*.exe" }
        #[PSCustomObject]@{ Name = "Pilixo"; DisplayName = "Pilixo"; ProcessName = "rdp"; IndicatorFilename = "rdp.exe", "Pilixo_Installer*.exe" }
        #[PSCustomObject]@{ Name = "Remcos"; DisplayName = "Remcos"; ProcessName = "xxxxx"; IndicatorFilename = "remcos*.exe" }
        #[PSCustomObject]@{ Name = "RuDesktop"; DisplayName = "RuDesktop"; ProcessName = "xxxxx"; IndicatorFilename = "rd.exe", "rudesktop*.exe" }
        #[PSCustomObject]@{ Name = "S3 Browser"; DisplayName = "xxxxx"; ProcessName = "xxxxx"; IndicatorFilename = "C:\Program Files (x86)\S3 Browser\*", "*\S3 Browser\*", "*\s3browser*.exe" }
        #[PSCustomObject]@{ Name = "SmartCode Web VNC"; DisplayName = "SmartCode Web VNC"; ProcessName = "xxxxx"; IndicatorFilename = "C:\Program Files\TightVNC\*", "*\TightVNC\*" }
        #[PSCustomObject]@{ Name = "SmartFTP"; DisplayName = "SmartFTP"; ProcessName = "xxxxx"; IndicatorFilename = "C:\Program Files (x86)\SmartFTP Client\en-US\", "*\SmartFTP Client\*", "*\SfShellTools.dll.mui" }
        #[PSCustomObject]@{ Name = "UltraVNC"; DisplayName = "UltraVNC"; ProcessName = "xxxxx"; IndicatorFilename = "UltraVNC*.exe" }
        #[PSCustomObject]@{ Name = "Zabbix Agent"; DisplayName = "Zabbix Agent"; ProcessName = "xxxxx"; IndicatorFilename = "zabbix_agent*.exe" }
    )
    #endregion initialization
}
